...
export function getIon(ionString: IonString): Ion | null {
  let ion = IONS[ionString as "SULFATE"];
  if (typeof ion === "undefined") ion = IONS[ION_MAP[ionString]];
  if (typeof ion === "undefined") return null;
  return ion;
}

export function getElement(key: ElementString | IonString): Element | Ion {
  const ion = () => {
...
export const ANION_MAP: AnionMap = {
  HYDRIDE: "HYDROGEN",
  BORIDE: "BORON",
  CARBIDE: "CARBON",
  SILICIDE: "SILICON",
